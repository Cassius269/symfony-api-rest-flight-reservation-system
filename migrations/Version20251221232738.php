 ...
 */
final class Version20251221232738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE flight (id INT AUTO_INCREMENT NOT NULL, airplane_id INT NOT NULL, captain_id INT NOT NULL, company_id INT NOT NULL, airport_departure_id INT NOT NULL, airport_arrival_id INT NOT NULL, date_departure DATETIME NOT NULL, date_arrival DATETIME NOT NULL, is_direct TINYINT(1) NOT NULL, is_canceled TINYINT(1) NOT NULL, is_late TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL, INDEX IDX_C257E60E996E853C (airplane_id), INDEX IDX_C257E60E3346729B (captain_id), INDEX IDX_C257E60E979B1AD6 (company_id), INDEX IDX_C257E60E90E8127C (airport_departure_id), INDEX IDX_C257E60E6E52B0FE (airport_arrival_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
