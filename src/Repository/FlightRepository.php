...
class FlightRepository extends ServiceEntityRepository
{
    ...
    public function findAvailableFlights(): ?array
    {
        return $this->createQueryBuilder('f')
            ...
            ->addSelect('aa.name AS airportArrival, ad.name AS airportDeparture')
            ...
            ->leftJoin('f.airportArrival', 'aa')
            ->leftJoin('f.airportDeparture', 'ad')
            ->where('f.dateDeparture > :now')
            ->setParameter('now', new \DateTime())
            ->groupBy('f.id, f.dateDeparture, f.dateArrival, aa.name, ad.name, am.capacity') // Include am.capacity
